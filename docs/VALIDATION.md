...
5. Verifique as quatro categorias, a opção Todas, os 13 comandos e suas descrições.
...
12. Abra o launcher na primeira apresentação, feche-o por `Esc`, pelo botão e pelo `X`, alterne para uma segunda apresentação e abra-o novamente após cada fechamento. O formulário deve reaparecer na janela ativa em todos os casos.
